...
* `nntp` - Replacement message table entries. The structure of `nntp` block is documented below. (`ver <= 6.4.0`)
...
* `ec` - Replacement message table entries. The structure of `ec` block is documented below. (`ver <= 6.2.0`)
* `device_detection_portal` - Replacement message table entries. The structure of `device_detection_portal` block is documented below. (`ver <= 6.4.0`)
...
* `automation` - Replacement message table entries. The structure of `automation` block is documented below. (`ver >= 6.6.0`)
...
The `nntp` block supports (`ver <= 6.4.0`):
...
The `ec` block supports (`ver <= 6.2.0`):
...
The `device_detection_portal` block supports (`ver <= 6.4.0`):
...
The `automation` block supports (`ver >= 6.6.0`):
