...
* `tlsv1_0` - Enable/disable TLSv1.0. (`ver <= 6.4.0`)
* `tlsv1_1` - Enable/disable TLSv1.1. (`ver <= 6.4.0`)
* `tlsv1_2` - Enable/disable TLSv1.2. (`ver <= 6.4.0`)
* `tlsv1_3` - Enable/disable TLSv1.3. (`ver <= 6.4.0`)
...
* `route_source_interface` - Enable to allow SSL-VPN sessions to bypass routing and bind to the incoming interface. (`ver <= 6.4.0`)
...
* `transform_backward_slashes` - Transform backward slashes to forward slashes in URLs. (`ver >= 6.4.0`)
* `encode_2f_sequence` - Encode \2F sequence to forward slash in URLs.
* `encrypt_and_store_password` - Encrypt and store user passwords for SSL-VPN web sessions. (`ver >= 6.4.0`)
