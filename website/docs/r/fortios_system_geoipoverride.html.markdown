...
* `ip6_range` - Table of IPv6 ranges assigned to country. The structure of `ip6_range` block is documented below. (`ver >= 6.4.0`)
...
The `ip6_range` block supports (`ver >= 6.4.0`):
