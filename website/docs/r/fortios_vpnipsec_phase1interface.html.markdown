...
* `aggregate_weight` - Link weight for aggregate. (`ver >= 6.4.0`)
...
* `auto_discovery_shortcuts` - Control deletion of child short-cut tunnels when the parent tunnel goes down. (`ver >= 6.6.0`)
...
* `fec_codec` - ipsec fec encoding/decoding algorithm (0: reed-solomon, 1: xor). (`ver >= 6.6.0`)
