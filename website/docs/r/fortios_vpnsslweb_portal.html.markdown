...
* `split_tunneling_routing_negate` - Enable to negate split tunneling routing address. (`ver >= 6.4.0`)
...
* `ipv6_split_tunneling_routing_negate` - Enable to negate IPv6 split tunneling routing address. (`ver >= 6.4.0`)
...
* `use_sdwan` - Use SD-WAN rules to get output interface. (`ver 6.2.6,6.6.0`)
